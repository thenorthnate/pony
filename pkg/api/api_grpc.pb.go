...
func (c *pubsubClient) Publish(ctx context.Context, opts ...grpc.CallOption) (Pubsub_PublishClient, error) {
	stream, err := c.cc.NewStream(ctx, &Pubsub_ServiceDesc.Streams[0], Pubsub_Publish_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *pubsubClient) Subscribe(ctx context.Context, in *Note, opts ...grpc.CallOption) (Pubsub_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &Pubsub_ServiceDesc.Streams[1], Pubsub_Subscribe_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
